...
class SegmentationModel(DetectionModel):
    ...
    def __init__(self, cfg="yolov8l-seg.yaml", ch=3, nc=None, verbose=True):
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (
            Classify,Conv,ConvTranspose,GhostConv,Bottleneck,GhostBottleneck, SPP,SPPF,DWConv,Focus,BottleneckCSP,C1,
            C2,C2f,C3,C3TR,C3Ghost,nn.ConvTranspose2d,DWConvTranspose2d,C3x,RepC3,
        ):
            c1, c2 = ch[f], args[0]
        ...
        # ---------------------------------------注意力机制------------------------
        elif m in { ECA, GAM, CoordAtt,CBAM ,SolderCbam,HCAtt,HCSAtt,CoordAtt_HOnly,HCAtt_Max,H_MAx_C_MaxAtt}:
            c2 = ch[f]
            args = [c2, *args]
        # ---------------------------------------注意力机制------------------------
